            ...
            >
              ...
              <div className="h-64 overflow-hidden border-b border-white/10 scanline-container">
                ...
                <div className="p-6">
                  ...
                  <span className="text-xs font-mono uppercase tracking-widest text-white border-b border-amber-accent pb-1 group-hover:text-amber-accent transition-colors">[ EXECUTE_MODULE ]</span>
                </div>
                </div>
              </a>
            ))}
